        ...
        <div class="col-lg-12 ">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form class="form-horizontal p-t-20" action="{{ route('sub-category.update',['id'=>$sub_category->category_id]) }}"  method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{ $sub_category->name }}" name="name" id="" placeholder="Category Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea  class="form-control" name="description" id="exampleInputEmail3" placeholder="Description">{{ $sub_category->description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{ asset($sub_category->image) }}"  alt="{{ $sub_category->name }}" width="130" height="100">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="form-label col-sm-9">
                                ...
                                <label><input type="radio" {{ $sub_category->status == 2 ? 'checked' : '' }} name="status" value="2" >Unpublished</label>
                            </div>
                        </div>
