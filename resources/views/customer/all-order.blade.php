            ...
            <div class="row justify-content-center">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a class="list-group-item list-group-item-action " aria-disabled="true">Change Password</a>
                        <a class="list-group-item list-group-item-action " aria-disabled="true">Account</a>
                        <a href="{{ route('customer.logout') }}" class="list-group-item list-group-item-action" aria-disabled="true">Log Out</a>
                    </div>
                </div>
