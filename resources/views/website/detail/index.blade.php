                ...
                <div class="row align-items-center">
                        ...
                        <div class="product-images">
                            <main id="gallery">
                                ...
                                <div class="images">
                                    ...
                                    <img src="{{ asset($otherImage->image) }}" id="current" alt="#">
                                    @endforeach
                                </div>
                            </main>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Category: <a href="javascript:void(0)">{{ $product->category->name }}</a>
                            </p>
                            <p class="category"><i class="lni lni-tag"></i> Sub Category: <a href="javascript:void(0)">{{ $product->subCategory->name }}</a>
                            </p>
                            <p class="category"><i class="lni lni-tag"></i> Brand: <a href="javascript:void(0)">{{ $product->brand->name }}</a>
                            </p>
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="wish-button">
                                            <button class="btn" type="button"><i class="lni lni-reload"></i> Compare</button>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="wish-button">
                                            <button class="btn" type="button"><i class="lni lni-heart"></i> To Wishlist</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
